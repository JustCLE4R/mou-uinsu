            ...
            <form action="{{ route('superadmin.mou.update', $submission->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                @if ($submission->final_agreement_file)
                                    <div class="mb-2">
                                        <a href="{{ asset('storage/' . $submission->final_agreement_file) }}" target="_blank"
                                            class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-eye"></i> Lihat File Saat Ini
                                        </a>
                                    </div>
                                @endif
                                <input type="file" name="final_agreement_file" id="final_agreement_file"
                                    class="form-control @error('final_agreement_file') is-invalid @enderror"
                                    accept=".pdf,.doc,.docx">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if ($submission->final_mou_file)
                                    <div class="mb-2">
                                        <a href="{{ asset('storage/' . $submission->final_mou_file) }}" target="_blank"
                                            class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-eye"></i> Lihat File Saat Ini
                                        </a>
                                    </div>
                                @endif
                                <input type="file" name="final_mou_file" id="final_mou_file"
                                    class="form-control @error('final_mou_file') is-invalid @enderror"
                                    accept=".pdf,.doc,.docx">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="institution_name" class="form-label">Nama Institusi <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="institution_name" id="institution_name"
                                    class="form-control @error('institution_name') is-invalid @enderror"
                                    value="{{ old('institution_name', $submission->institution_name) }}" required>
                                @error('institution_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="institution_type" class="form-label">Tipe Institusi <span
                                        class="text-danger">*</span></label>
                                <select name="institution_type" id="institution_type"
                                    class="form-select @error('institution_type') is-invalid @enderror" required>
                                    <option value="">Pilih Tipe</option>
                                    @foreach (['SMK', 'SMA', 'Perguruan Tinggi', 'Vendor', 'Brand', 'Pemerintah', 'Lainnya'] as $type)
                                        <option value="{{ $type }}"
                                            {{ old('institution_type', $submission->institution_type) == $type ? 'selected' : '' }}>
                                            {{ $type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="institution_address" class="form-label">Alamat Institusi <span
                                        class="text-danger">*</span></label>
                                <textarea name="institution_address" id="institution_address"
                                    class="form-control @error('institution_address') is-invalid @enderror" rows="3" required>{{ old('institution_address', $submission->institution_address) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" name="institution_website" id="institution_website"
                                    ...
                                    value="{{ old('institution_website', $submission->institution_website) }}">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pic_name" class="form-label">Nama PIC <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="pic_name" id="pic_name"
                                    class="form-control @error('pic_name') is-invalid @enderror"
                                    value="{{ old('pic_name', $submission->pic_name) }}" required>
                                @error('pic_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="pic_position" class="form-label">Jabatan PIC <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="pic_position" id="pic_position"
                                    class="form-control @error('pic_position') is-invalid @enderror"
                                    value="{{ old('pic_position', $submission->pic_position) }}" required>
                                @error('pic_position')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="pic_phone" class="form-label">No. Telepon PIC <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="pic_phone" id="pic_phone"
                                    class="form-control @error('pic_phone') is-invalid @enderror"
                                    value="{{ old('pic_phone', $submission->pic_phone) }}" required>
                                @error('pic_phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="pic_email" class="form-label">Email PIC <span
                                        class="text-danger">*</span></label>
                                <input type="email" name="pic_email" id="pic_email"
                                    class="form-control @error('pic_email') is-invalid @enderror"
                                    value="{{ old('pic_email', $submission->pic_email) }}" required>
                                @error('pic_email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            @foreach ($documents as $field => $label)
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if ($submission->$field)
                                        <div class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="{{ asset('storage/' . $submission->$field) }}" download
                                    ...
                                    <input type="file" name="{{ $field }}" id="{{ $field }}"
                                        ...
                                        accept=".pdf,.doc,.docx">
                                    <small class="text-muted">Upload file baru untuk mengganti (PDF, DOC, DOCX, max
                                        20MB)</small>
                                    @error($field)
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="cooperation_title" class="form-label">Judul Kerja Sama <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="cooperation_title" id="cooperation_title"
                                    class="form-control @error('cooperation_title') is-invalid @enderror"
                                    value="{{ old('cooperation_title', $submission->cooperation_title) }}" required>
                                @error('cooperation_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="cooperation_description" class="form-label">Deskripsi Kerja Sama <span
                                        class="text-danger">*</span></label>
                                <textarea name="cooperation_description" id="cooperation_description"
                                    class="form-control @error('cooperation_description') is-invalid @enderror" rows="4" required>{{ old('cooperation_description', $submission->cooperation_description) }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div>
                                    @php
                                        $currentScope = is_string($submission->cooperation_scope)
                                            ? json_decode($submission->cooperation_scope, true) ?? []
                                            : $submission->cooperation_scope ?? [];
                                    @endphp
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="target_unit" class="form-label">Unit Tujuan <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="target_unit" id="target_unit"
                                    class="form-control @error('target_unit') is-invalid @enderror"
                                    value="{{ old('target_unit', $submission->target_unit) }}" required>
                                @error('target_unit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" name="start_date" id="start_date"
                                    ...
                                    value="{{ old('start_date', $submission->start_date ? \Carbon\Carbon::parse($submission->start_date)->format('Y-m-d') : '') }}">
                                @error('start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" name="end_date" id="end_date"
                                    ...
                                    value="{{ old('end_date', $submission->end_date ? \Carbon\Carbon::parse($submission->end_date)->format('Y-m-d') : '') }}">
                                @error('end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="planned_activities" class="form-label">Rencana Kegiatan <span
                                        class="text-danger">*</span></label>
                                <textarea name="planned_activities" id="planned_activities"
                                    class="form-control @error('planned_activities') is-invalid @enderror" rows="3" required>{{ old('planned_activities', $submission->planned_activities) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="signing_location" id="signing_location"
                                    class="form-control @error('signing_location') is-invalid @enderror"
                                    value="{{ old('signing_location', $submission->signing_location) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="special_request" id="special_request"
                                    ...
                                    value="{{ old('special_request', $submission->special_request) }}">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="additional_notes" id="additional_notes"
                                    class="form-control @error('additional_notes') is-invalid @enderror" rows="3">{{ old('additional_notes', $submission->additional_notes) }}</textarea>
