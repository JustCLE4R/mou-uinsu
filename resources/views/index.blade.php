              ...
              >
                <div class="input-group input-group-lg">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="keyword"
                    placeholder="Cari informasi kerja sama, bidang, mitra..."
                    aria-label="Search"
                  />
          ...
          <div class="row justify-content-center">
            <div class="col-lg-5 col-12 mb-4 mb-lg-0">
              <div class="custom-block bg-white shadow-lg">
                  ...
                  <img
                    src="img/topics/undraw_Remote_design_team_re_urdx.png"
                    class="custom-block-image img-fluid"
                    alt="Tentang Kerja Sama"
                  />
                ...
                <div class="d-flex flex-column h-100">
                  ...
                  <div class="custom-block-overlay-text d-flex">
                    <div>
                      ...
                      <a href="{{ route('mou-submission') }}" class="btn custom-btn mt-2 mt-lg-3"
                        >Ajukan MOU</a
                      >
                    </div>
            ...
            >
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="pendidikan-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#pendidikan-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="pendidikan-tab-pane"
                  aria-selected="true"
                >
                  Pendidikan
                </button>
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="penelitian-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#penelitian-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="penelitian-tab-pane"
                  aria-selected="false"
                >
                  Penelitian
                </button>
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="magang-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#magang-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="magang-tab-pane"
                  aria-selected="false"
                >
                  Magang
                </button>
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="kompetensi-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#kompetensi-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="kompetensi-tab-pane"
                  aria-selected="false"
                >
                  Kompetensi
                </button>
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  id="sosial-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#sosial-tab-pane"
                  type="button"
                  role="tab"
                  aria-controls="sosial-tab-pane"
                  aria-selected="false"
                >
                  Sosial & Keagamaan
                </button>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4">
                      <div class="custom-block bg-white shadow-lg">
                        <a href="#">
                          ...
                          <img
                            src="img/topics/undraw_Graduation_re_gthn.png"
                            class="custom-block-image img-fluid"
                            alt=""
                          />
                        </a>
                      ...
                      <div class="custom-block bg-white shadow-lg">
                        <a href="#">
                          <div class="d-flex">
                            ...
                            <span
                              class="badge bg-education rounded-pill ms-auto"
                              >✅</span
                            >
                          </div>
                          <img
                            src="img/topics/undraw_Finance_re_gnv2.png"
                            class="custom-block-image img-fluid"
                            alt=""
                          />
                        </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4">
                      <div class="custom-block bg-white shadow-lg">
                        <a href="#">
                          ...
                          <img
                            src="img/topics/colleagues-working-cozy-office-medium-shot.png"
                            class="custom-block-image img-fluid"
                            alt=""
                          />
                        </a>
                      ...
                      <div class="custom-block bg-white shadow-lg">
                        <a href="#">
                          <div class="d-flex">
                            ...
                            <span
                              class="badge bg-advertising rounded-pill ms-auto"
                              >✅</span
                            >
                          </div>
                          <img
                            src="img/topics/undraw_online_ad_re_ol62.png"
                            class="custom-block-image img-fluid"
                            alt=""
                          />
                        </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4">
                      <div class="custom-block bg-white shadow-lg">
                        <a href="#">
                          ...
                          <img
                            src="img/topics/undraw_Podcast_audience_re_4i5q.png"
                            class="custom-block-image img-fluid"
                            alt=""
                          />
                        </a>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-6 mb-4 mb-lg-0">
            ...
            <p class=" d-flex mb-1">
              ...
              <a href="tel:+620000000000" class="site-footer-link"
                >+62 000-0000-0000</a
              >
            </p>
            <p class=" d-flex">
              <i class="bi-envelope me-2"></i>
              <a href="mailto:kerjasama@uinsu.ac.id" class="site-footer-link"
                >kerjasama@uinsu.ac.id</a
              >
            </p>
          </div>
