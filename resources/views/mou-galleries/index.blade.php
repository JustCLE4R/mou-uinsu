...
<head>
    ...
    <title>Galeri MOU - UINSU Medan</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-12 mx-auto">
                        <h1 class="text-white text-center">Galeri Dokumentasi MOU</h1>
                        <h6 class="text-center text-white">
                            Dokumentasi Kerja Sama & Partnership UINSU Medan
                        </h6>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        @if ($galleries->isEmpty())
                            <div class="text-center py-5">
                                <h4>Belum ada dokumentasi yang dipublikasikan.</h4>
                                <p class="text-muted">Gallery akan diperbarui seiring dengan penandatanganan MOU baru.</p>
                            </div>
                        @else
                            <div class="row g-4">
                                        ...
                                        <div class="custom-block bg-white shadow-lg h-100">
                                            ...
                                            <div class="custom-block-info">
                                                <div class="d-flex align-items-center mb-2">
                                                    <span class="badge bg-primary me-2">{{ $gallery->mouSubmission->institution_type }}</span>
                                                </div>
                                                <h6 class="mb-1">{{ $gallery->mouSubmission->institution_name }}</h6>
                                                <p class="mb-2 text-muted small">{{ $gallery->mouSubmission->cooperation_title }}</p>
                                                @if($gallery->caption)
                                                    <p class="mb-2 small">{{ $gallery->caption }}</p>
                                                @endif
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">
                                                            {{ $gallery->mouSubmission->institution_name }}
                                                        </h5>
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <img src="{{ asset('storage/' . $gallery->image_path) }}" 
                                                             ...
                                                             alt="Gallery Image">
                                                        <div class="mt-3">
                                                            <h6>{{ $gallery->mouSubmission->cooperation_title }}</h6>
                                                            <span class="badge bg-primary">{{ $gallery->mouSubmission->institution_type }}</span>
                                                            @if($gallery->caption)
                                                                <p class="mt-3 mb-0 text-muted">{{ $gallery->caption }}</p>
                                                            @endif
                                                            <small class="d-block mt-2 text-muted">
                                                                Dipublikasikan: {{ $gallery->created_at->format('d M Y H:i') }}
                                                            </small>
                                                        </div>
                                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <ul class="site-footer-links">
                        ...
                        <li class="site-footer-link-item">
                            <a href="{{ route('mou-galleries.index') }}" class="site-footer-link">Galeri</a>
                        </li>
                    </ul>
                </div>
