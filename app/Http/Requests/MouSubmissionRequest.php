...
class MouSubmissionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'cooperation_scope'     => 'required|array',
    ...
    public function messages(): array
    {
        return [
            ...
            'legal_doc_operasional.max'    => 'Dokumen operasional maksimal 2MB.',

            // Informasi Kerja Sama
            'cooperation_title.required'   => 'Judul kerja sama wajib diisi.',
            'cooperation_description.required' => 'Deskripsi kerja sama wajib diisi.',
            'cooperation_scope.required'   => 'Ruang lingkup kerja sama wajib diisi.',
